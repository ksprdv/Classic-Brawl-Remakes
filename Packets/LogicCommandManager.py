...
from Packets.Commands.Client.LogicPurchaseTicketsCommand import LogicPurchaseTicketsCommand
...
class EndClientTurn(BSMessageReader):
    ...
    def process(self):
        ...
        elif self.commandID == 518:
            LogicPurchaseTicketsCommand.decode(self)
            LogicPurchaseTicketsCommand.process(self)
